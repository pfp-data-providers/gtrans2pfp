...
index_file = "./gtrans-listperson.xml"
entity_type = "person"
...
for x in tqdm(items, total=len(items)):
    ...
    try:
        ...
        event_graph, birth_uri, birth_timestgtrans = make_birth_death_entities(
            subj,
            x,
            f"{PU}",
            event_type="birth",
    ...
    try:
        ...
        event_graph, death_uri, birth_timestgtrans = make_birth_death_entities(
            subj,
            x,
            f"{PU}",
            event_type="death",
